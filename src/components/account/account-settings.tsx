...
type Account = { phone: string; reportCount: number; paymentCount: number; purchases: Array<{ id: string; amount: number; currency: string; status: string; createdAt: string; report: { id: string; chatName: string; deletedAt: string | null } }> };
