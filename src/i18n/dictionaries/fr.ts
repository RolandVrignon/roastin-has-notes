...
const dictionary = {
  ...
  landing: {
    ...
    privacyNote: "La conversation originale n’est pas conservée après la génération", trust: ["Sans compte", "Privé par défaut", "Prêt en quelques minutes"],
  ...
  onboarding: {
    ...
    review: { eyebrow: "Casting", title: "Vérifie qu’on a bien lu la salle.", text: "Utilise des prénoms ou surnoms. Ce sont les noms affichés dans le rapport.", chatName: "Nom du chat" },
  ...
  pages: {
    privacy: { eyebrow: "Confidentialité", title: "Ce que nous traitons, conservons et supprimons", intro: "Cette notice en langage clair décrit le produit tel qu’il fonctionne aujourd’hui. Elle ne prétend pas que nous ne stockons rien.", sections: [
      ...
      { title: "Ce que nous conservons", paragraphs: ["Nous stockons le rapport dérivé et son aperçu, le nom du chat, la langue, les totaux agrégés, les dates, l’identifiant du modèle et la trace de fin du traitement brut."], bullets: ["Un jeton anonyme de propriétaire, haché côté serveur", "L’email et les codes de connexion temporaires si un compte est créé", "Les références Stripe de paiement", "Les liens de partage révocables", "Pour WhatsApp : numéro chiffré, empreinte, consentement, template, identifiant fournisseur et statut"] },
      ...
      { title: "Sous-traitants et transferts", paragraphs: ["Selon les fonctions activées, les données peuvent être traitées par l’hébergeur, la base de données, OpenRouter et le modèle choisi, Stripe, le prestataire email et Meta pour une livraison WhatsApp demandée. Leurs localisations et garanties doivent être documentées avant lancement."] },
    ...
    help: { eyebrow: "Aide", title: "Un export propre pour un meilleur rapport", intro: "Les réponses rapides sur l’import, la confidentialité, l’accès et le partage.", sections: [
      ...
      { title: "Accès et partage", paragraphs: ["Garde le même navigateur pour retrouver un rapport sans compte, ou connecte-toi avec l’email du paiement. Un rapport payé peut créer un lien révocable. WhatsApp reste facultatif et soumis à consentement."] },
    ] },
    contact: { eyebrow: "Contact", title: "Parler à un humain", intro: "Pour l’aide produit, les demandes de confidentialité ou la sécurité, écris à l’adresse ci-dessous sans inclure le contenu du chat.", sections: [
      { title: "Support", paragraphs: ["Écris à support@roastinhasnotes.com avec l’identifiant du rapport, l’email de paiement si utile et une courte description. Ne joins jamais l’export."] },
      ...
      { title: "Sécurité", paragraphs: ["Utilise l’objet « Signalement de sécurité ». La boîte support doit être créée et surveillée avant lancement."] },
    ] },
    delete: { eyebrow: "Suppression", title: "Supprimer un rapport ou les données de livraison", intro: "La suppression est disponible depuis la page privée du rapport. La suppression globale d’un compte exige encore une demande support vérifiée dans cette bêta.", sections: [
      ...
      { title: "Supprimer un compte", paragraphs: ["Écris à support@roastinhasnotes.com avec l’objet « Demande de suppression », sans envoyer la conversation. Nous vérifierons la propriété. La suppression automatisée du compte n’est pas encore implémentée."] },
    ] },
  },
