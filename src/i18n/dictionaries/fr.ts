...
const dictionary = {
  ...
  onboarding: {
    ...
    verification: { eyebrow: "Une dernière étape", title: "Garde ton rapport.", text: "Vérifie maintenant ton numéro WhatsApp pour créer le rapport et recevoir son lien privé après le paiement.", phoneLabel: "Numéro WhatsApp", consent: "J’accepte de recevoir le code de vérification et les liens transactionnels du rapport sur WhatsApp. Aucun message marketing.", sendCode: "Envoyer le code sur WhatsApp", codeTitle: "Regarde sur WhatsApp.", codeText: "Nous avons envoyé un code à six chiffres au {phone}.", codeLabel: "Code à six chiffres", verifyAndLaunch: "Vérifier et créer mon rapport", differentNumber: "Utiliser un autre numéro", sessionExpired: "Ta session a expiré. Vérifie ton numéro WhatsApp pour continuer." },
