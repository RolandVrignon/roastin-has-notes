...
const dictionary = {
  ...
  onboarding: { ...pt.onboarding,
    ...
    review: { eyebrow: "Elenco", title: "Confira se entendemos o grupo.", text: "Use nomes ou apelidos. Eles aparecerão no relatório.", chatName: "Nome do chat", participantName: "Nome exibido", invalidNames: "Cada pessoa precisa de um nome ou apelido único." },
    verification: { eyebrow: "Só mais uma etapa", title: "Guarde seu relatório.", text: "Verifique agora seu número do WhatsApp para criar o relatório e receber o link privado depois do pagamento.", phoneLabel: "Número do WhatsApp", consent: "Aceito receber o código de verificação e os links transacionais do relatório pelo WhatsApp. Sem marketing.", sendCode: "Enviar código pelo WhatsApp", codeTitle: "Confira o WhatsApp.", codeText: "Enviamos um código de seis dígitos para {phone}.", codeLabel: "Código de seis dígitos", verifyAndLaunch: "Verificar e criar meu relatório", differentNumber: "Usar outro número", sessionExpired: "Sua sessão expirou. Verifique seu número do WhatsApp para continuar." },
