...
const dictionary = {
  ...
  landing: { ...pt.landing,
    titleBefore: "Seu chat tem", titleAfter: "Roastin anotou tudo.", subtitle: "Envie uma conversa do WhatsApp. Receba o relatório sem filtro e estranhamente certeiro que ninguém do grupo teria coragem de escrever.", privacyNote: "A conversa original não é armazenada depois da geração", trust: ["Sem conta", "Privado por padrão", "Pronto em minutos"],
